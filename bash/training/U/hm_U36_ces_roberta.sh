...
--num_features 36 --loadpre ./data/uniter-large.pt --num_pos 6 --contrib --exp U36 --topk $topk --tr_unimodal_name /home/ML_courses/DL2020/efratblaier/test-mlm-large-batch-roberta-base
