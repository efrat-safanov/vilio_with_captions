...
#python hm_pretrain_ctm.py --seed 129 --model U \
#--train train --valid dev_seen --test dev_seen,test_seen --lr 1e-5 --batchSize 8 --tr bert-large-cased --epochs 10 --tsv \
...
python hm_pretrain_ctm.py --seed 129 --model U \
--train traindev --valid dev_seen --test dev_seen,test_seen --lr 1e-5 --batchSize 8 --tr bert-large-cased --epochs 10 --tsv \
--num_features 36 --loadpre ./data/uniter-large.pt --num_pos 6 --contrib --exp U36 --topk $topk #--tr_unimodal_name /home/ML_courses/DL2020/efratblaier/test-mlm-large-batch-roberta-100-epochs-captions-no-rand
